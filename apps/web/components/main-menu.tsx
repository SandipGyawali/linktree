...
import { Icons } from "@linktree/ui/icons";
import Link from "next/link";
import { usePathname } from "next/navigation";
import { useEffect, useState } from "react"

const DefaultIcon = () => <Icons.Overview />;

const icons = {
  "/": () => <Icons.Overview />,
  "/settings": () => <Icons.Settings />,
  "/settings/billing": () => <Icons.Settings />,
  "/settings/accounts": () => <Icons.Settings />,
  "/#": () => <Icons.Settings />,
  "/links": () => <Icons.Settings />,
}
...
const navItems = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: "settings/accounts", name: "Accounts" },
    ]
  }
];
...
const Item = ({
  ...
  const Icon = icons[item.path as keyof typeof icons] ?? DefaultIcon;
